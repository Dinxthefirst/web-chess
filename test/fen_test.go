...
func TestFenAfterMultipleMoves(t *testing.T) {
	...
	g.MakeMove(game.Move{StartSquare: 12, TargetSquare: 28}) // e4
	g.MakeMove(game.Move{StartSquare: 50, TargetSquare: 34}) // c5
	...
	g.MakeMove(game.Move{StartSquare: 6, TargetSquare: 21}) // Nf3
...
func TestFenAfterCastling(t *testing.T) {
	...
	err := g.MakeMove(game.Move{StartSquare: 4, TargetSquare: 2}) // O-O-O
...
func TestFenAfterEnPassant(t *testing.T) {
	...
	g.MakeMove(game.Move{StartSquare: 36, TargetSquare: 43}) // exd5
